...
2. Finding the optimal $\theta^*(\phi, {}\_{i}D\_{train}^{meta\-train})$ value for base learner with loss $\mathcal{L}(\theta; \phi, {}\_iD_{train}^{meta-train})$
...
<div style="width: 800px; padding-left: 100px;"> <img alt="zygote-adjoint-1" src="assets/zygote-adjoint-1.png" style="width: 40%;"> <img alt="zygote-adjoint-2" src="assets/zygote-adjoint-2.png" style="width: 50%; float: right;"> </div>
...
<div style="margin-left: 60px; font-size: 32px;"> But the model is not working ... </div>
