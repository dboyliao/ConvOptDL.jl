...
_format_batch(batch; support::Val{true}) = reshape(batch.support_samples, size(batch.support_samples)[1:end-2]..., :)
_format_batch(batch; support::Val{false}) = reshape(batch.query_samples, size(batch.query_samples)[1:end-2]..., :)
